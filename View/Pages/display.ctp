...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> <?php echo __('Current Month Expenses'); ?></div>
            <div class="card-body">
                <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                    <thead>
                        <tr>
                            <th style="width: 20%;"><?php echo __('Category'); ?></th>
                            <th style="width: 25%;" data-class="expand" class="text-right"><?php echo __('Amount'); ?></th>
                    ...
                    <tbody>
                        <?php foreach($expensesCurrentMonth as $key => $expense): ?>
                        <tr>
                            <td>
                                <?php
                                echo $this->Html->link(
