...
$breadcrumbs[0] = array('title' => $title);
                ...
                <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th data-hide="phone" style="width: 20%;"><?php echo __('Parent'); ?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo h($category['ParentCategory']['title']); ?></td>
                            <td>
                                <?php 
                                echo $this->Balance->dateFormat('d M Y',
                                    h($category['Category']['created'])
                                );
                                ?>
                            </td>
